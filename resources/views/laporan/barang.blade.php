                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('laporan.export', ['type' => 'barang']) }}" class="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded text-sm">
                                Export Excel
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-xl font-semibold text-gray-900">{{ count($barang) }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-xl font-semibold text-gray-900">{{ $barang->pluck('kategori')->unique()->count() }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
