                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data"
                          x-data="{ 
                              ...
                              subKategoris: [],
                              oldSubKategoriId: '{{ old('sub_kategori_id') }}',
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="jumlah" class="block mt-1 w-full" type="number" name="jumlah" :value="old('jumlah', 0)" min="0" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="stok" class="block mt-1 w-full" type="number" name="stok" :value="old('stok', 0)" min="0" required />
