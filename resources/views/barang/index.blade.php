                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900">{{ $allBarangs->count() }}</div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900">{{ $allBarangs->where('kondisi', 'baik')->count() }}</div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900">{{ $allBarangs->where('kondisi', 'kurang_baik')->count() }}</div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900">{{ $allBarangs->where('kondisi', 'rusak')->count() }}</div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900">{{ $allBarangs->sum('jumlah') }}</div>
