...
<?php $component->withAttributes([]); ?>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-2">
                        <form action="<?php echo e(route('barang.manage')); ?>" method="GET" class="flex space-x-2">
                            ...
                            <?php if(request('kategori') === 'perpustakaan'): ?>
                                <select name="sub" class="text-sm rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    ...
                                    <?php $__currentLoopData = $categories['perpustakaan']['sub']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subKey => $subValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($subKey); ?>" <?php echo e(request('sub') == $subKey ? 'selected' : ''); ?>>
                                            <?php echo e($subValue); ?>
                            ...
                            <?php if(request('kategori') || request('sub')): ?>
                                <a href="<?php echo e(route('barang.manage')); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md text-sm">Reset</a>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900"><?php echo e($allBarangsManage->count()); ?></div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900"><?php echo e($allBarangsManage->where('kondisi', 'baik')->count()); ?></div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900"><?php echo e($allBarangsManage->where('kondisi', 'kurang_baik')->count()); ?></div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900"><?php echo e($allBarangsManage->where('kondisi', 'rusak')->count()); ?></div>
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xl font-semibold text-gray-900"><?php echo e($allBarangsManage->sum('jumlah')); ?></div>
                ...
                <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-4" role="alert">
                    <p>Debug Info: <?php echo e(session('debug')); ?></p>
                </div>
                <?php endif; ?>

                <!-- Search Box -->
                <div class="mb-4">
                    <form action="<?php echo e(route('barang.manage')); ?>" method="GET" class="relative">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border-b border-gray-200">
                                        <div class="flex space-x-2">
                                            ...
                                            <!-- Direct delete link -->
                                            <a href="<?php echo e(route('barang.bulk-destroy-get')); ?>?ids=<?php echo e($barang->id); ?>" 
...
<?php endif; ?> <?php /**PATH C:\laragon\www\inventaris-smk-sasmita\resources\views/barang/manage.blade.php ENDPATH**/ ?>